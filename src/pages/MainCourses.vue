<template>
  <q-page class="flex flex-center row text-center">
    <div class="q-ma-sm col-11 text-h4 text-weight-medium">Platos principales</div>
    <div class="q-ma-sm col-11 text-h4 text-weight-medium text-italic">Main Courses</div>
    <Item
